...
const CONFIG = {
  ...
  duckScale: 0.4,     // итоговый размер уточки относительно стикера (≈0.66 ширины стикера). Больше число = крупнее уточка
  duckOffsetY: 0.05,  // подъём над центром стикера
  duckOffsetZ: 0.12,  // «выезд» уточки в сторону зрителя от стены
  bobAmplitude: 0.06, // насколько качается вверх-вниз
